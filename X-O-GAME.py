...
def checkwinner(TAB):
    ...
    if ((TAB[6]=='X' and TAB[7]=='X' and TAB[8]=='X') or (TAB[3]=='X' and TAB[4]=='X' and TAB[5]=='X') or (TAB[0]=='X' and TAB[1]=='X' and TAB[2]=='X')    or     (TAB[6]=='X' and TAB[3]=='X' and TAB[0]=='X') or (TAB[7]=='X' and TAB[4]=='X' and TAB[1]=='X') or (TAB[8]=='X' and TAB[5]=='X' and TAB[2]=='X')  or   (TAB[6]=='X' and TAB[4]=='X' and TAB[2]=='X') or (TAB[0]=='X' and TAB[4]=='X' and TAB[8]=='X')):
        return'X'
    # check if player Y won , if player Y won it will return 'Y'
    elif ((TAB[6]=='Y' and TAB[7]=='Y' and TAB[8]=='Y') or (TAB[3]=='Y' and TAB[4]=='Y' and TAB[5]=='Y') or (TAB[0]=='Y' and TAB[1]=='Y' and TAB[2]=='Y')    or     (TAB[6]=='Y' and TAB[3]=='Y' and TAB[0]=='Y') or (TAB[7]=='Y' and TAB[4]=='Y' and TAB[1]=='Y') or (TAB[8]=='Y' and TAB[5]=='Y' and TAB[2]=='Y')  or   (TAB[6]=='Y' and TAB[4]=='Y' and TAB[2]=='Y') or (TAB[0]=='Y' and TAB[4]=='Y' and TAB[8]=='Y')):
        return 'Y'
...
while init.lower()=='yes':
    ...
    # else, we will start playing
    	...
    	#game_still = True   means that the game it's still, once one of those players won we will assigne the value False to that boolean
        game_still = True
        ...
        # generate random integer from the range [0,1] , if is it  1 means player X  will play first, if is it 0 means player Y  will play first
        playerx = randint(0,1)
        ...
        while (game_still):
            ...
            if playerx == 1:
                ...
                # else , the number was in the available range
                    ...
                    # we will use this for loop to search for the index of the number given by the player x, when we will find the index , we will assigne the value 'X' to that item to indicate that the item is no longer available in the range 
                    ...
                    for i,j in enumerate(available_range):
                             ...
                             if (xchose==j):	# looking for the item 
                                  ...
                                  if (checkwinner(available_range)) == 'X':
                                      print("=========================\nCongratulations\n=======================\nWINNER IS PLAYER X\n=====================")
                                      # if player x won , we will end the game by assigning the value False into this boolean, which going to interrupt the while loop
                                      game_still = False
